...
import audio1 from '../radio/UNIVERSIDADE EM MOVIMENTO 8.08.2022.mp3'
import audio2 from '../radio/UNIVERSIDADE EM MOVIMENTO 10.08.2022.mp3'
    ...
    <>        
        <Container>
            ...
            <Row className="rowradio">
                <Col md="4">
                    <span class="sr-only">8.08.2022<br/>Segunda-feira</span><br/>
                    <audio controls>                        
                ...
                <Col md="4">
                    <span class="sr-only">10.08.2022<br/>Quarta-feira</span><br/>
                    <audio controls>                        
